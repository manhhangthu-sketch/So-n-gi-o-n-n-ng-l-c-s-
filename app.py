...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thế Mạnh - Trường TH Hùng An - ĐT: 0918461978</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thế Mạnh - Trường TH Hùng An - ĐT: 0918461978</div>", unsafe_allow_html=True)
